...
<body>
 ...
 <p class="Sign"> Sign in to continue </p>
  ...
  <form name="login" action="" method="post">
        ...
        <input class="btn btn-default"type="submit" name="submit" id="button" value="LOGIN" style="color: white; width: 150px; margin: 20px; margin-left: 35%;justify-content: center; align-content: center; display: flex; height: 30px; font-family: 'DM Sans', sans-serif;">
